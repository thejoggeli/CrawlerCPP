...
class Camera {
    ...
    recalcBoundsAABB(){
        ...
        this.bounds.left = this.position.x - (canvas.height*aspect*0.5) / this.zoom;
        this.bounds.right = this.position.x + (canvas.height*aspect*0.5) / this.zoom;
        this.bounds.top = this.position.y - (canvas.height*0.5) / this.zoom;
        this.bounds.bottom = this.position.y + (canvas.height*0.5) / this.zoom;
        this.bounds.width = this.bounds.right - this.bounds.left
        this.bounds.height = this.bounds.bottom - this.bounds.top
    }
    simpleMove(speed){

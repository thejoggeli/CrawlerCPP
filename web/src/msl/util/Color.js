...
class Color {
    ...
    rgbfloat_to_rgb(){    
        this.r = this.r_float >= 1.0 ? 255 : Math.floor(this.r*256)
        this.g = this.g_float >= 1.0 ? 255 : Math.floor(this.g*256)
        this.b = this.b_float >= 1.0 ? 255 : Math.floor(this.b*256)
        return this
    }
    rgbafloat_to_rgba(){        
        this.r = this.r_float >= 1.0 ? 255 : Math.floor(this.r*256)
        this.g = this.g_float >= 1.0 ? 255 : Math.floor(this.g*256)
        this.b = this.b_float >= 1.0 ? 255 : Math.floor(this.b*256)
        this.a = this.a_float >= 1.0 ? 255 : Math.floor(this.a*256)
        return this
    }
    rgba_to_rgba32(){

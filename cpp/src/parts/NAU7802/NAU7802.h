...
public:
  ...
  bool begin(I2CDevice* i2c, bool reset = true); //Check communication and initialize sensor
  ...
  bool waitForCalibrateAFE(uint64_t timeout_ms = 0); //Wait for asynchronous AFE calibration to complete with optional timeout.
...
private:
  I2CDevice* i2c;                   //This stores the user's requested i2c port
